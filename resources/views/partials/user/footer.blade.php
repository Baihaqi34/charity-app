            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    <div class="flex items-center mb-6">
                        ...
                        <span class="ml-2 text-xl font-bold">DanaKita</span>
                    </div>
                    <p class="text-gray-400 mb-4">Platform penggalangan dana terpercaya untuk membantu sesama dalam
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">Pusat
                                Bantuan</a></li>
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">Syarat &
                                Ketentuan</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">Cara
                                Donasi</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition duration-300">Cara
                                Galang Dana</a></li>
                    </ul>
